  ...
  return (
    <div style={homeStyles.container}>
      ...
      <div style={homeStyles.body}>
        ...
        <p>After we're gone, only a handful of companies will remain in the history books as essential in pushing forward a significant economic, cultural, or technological movement. Delphi allies with founders embarking on grand quests to enter the canon.</p>
